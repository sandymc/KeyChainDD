...
enum {
	KDDApplicationInit    = (0),
	KDDApplicationStartFromServices,
	KDDApplicationStartFromCommand,
	KDDApplicationRunning
};


@interface NSKeychainApplication : NSApplication {
	int applicationState;
	int keyChainTimerVal;
	int MIDrawerTimerVal;
	int keychainTimeOutCache;
	int MIDrawerTimeOutCache;
	NSTimer * lockTimer;
